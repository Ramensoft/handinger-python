...
```python
from handinger.types import CreateWorker, Worker, WorkerRetrieveEmailResponse
```
...
- <code title="get /api/workers/{workerId}">client.workers.<a href="./src/handinger/resources/workers/workers.py">retrieve</a>(worker_id) -> <a href="./src/handinger/types/worker.py">Worker</a></code>
