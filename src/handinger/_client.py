...
from ._exceptions import APIStatusError, HandingerError
...
class Handinger(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Handinger client instance.

        This automatically infers the `api_key` argument from the `HANDINGER_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("HANDINGER_API_KEY")
        if api_key is None:
            raise HandingerError(
                "The api_key client option must be set either by passing api_key to the client or by setting the HANDINGER_API_KEY environment variable"
            )
    ...
    def with_raw_response(self) -> HandingerWithRawResponse:
        return HandingerWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> HandingerWithStreamedResponse:
        return HandingerWithStreamedResponse(self)
...
class AsyncHandinger(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncHandinger client instance.
    ...
    def with_raw_response(self) -> AsyncHandingerWithRawResponse:
        return AsyncHandingerWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncHandingerWithStreamedResponse:
        return AsyncHandingerWithStreamedResponse(self)
...
class HandingerWithRawResponse:
    _client: Handinger

    def __init__(self, client: Handinger) -> None:
        self._client = client
...
class AsyncHandingerWithRawResponse:
    _client: AsyncHandinger

    def __init__(self, client: AsyncHandinger) -> None:
        self._client = client
